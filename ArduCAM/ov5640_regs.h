...
const struct sensor_reg Auto_Focus[] PROGMEM =
	{
		{0x3000, 0x20},
		{0x8000, 0x02},
		{0x8001, 0x0f},
...
const struct sensor_reg YUV_Sensor_Dvp_Init[] PROGMEM =
	{
		{0x4740, 0x20},
...
const struct sensor_reg vga_preview[] PROGMEM =
	{
...
const struct sensor_reg RGB_QVGA[] PROGMEM =
	{
		{0x3008, 0x02},
		{0x3035, 0x41},
		{0x4740, 0x21},
...
//2592x1944 QSXGA
const struct sensor_reg JPEG_QSXGA[] PROGMEM =
	{
		{0x3820, 0x40},
		{0x3821, 0x26},
		{0x3814, 0x11},
...
//320x240 QVGA
const struct sensor_reg QSXGA2QVGA[] PROGMEM =
	{
		{0x3800, 0x00},
		{0x3801, 0x00},
		{0x3802, 0x00},
...
//640x480 VGA
const struct sensor_reg QSXGA2VGA[] PROGMEM =
	{
		{0x3800, 0x00},
		{0x3801, 0x00},
		{0x3802, 0x00},
...
//800x480 WVGA
const struct sensor_reg QSXGA2WVGA[] PROGMEM =
	{
		{0x3800, 0x00},
		{0x3801, 0x00},
		{0x3802, 0x00},
...
//352x288 CIF
const struct sensor_reg QSXGA2CIF[] PROGMEM =
	{
		{0x3800, 0x00},
		{0x3801, 0x00},
		{0x3802, 0x00},
...
//1280x960 SXGA
const struct sensor_reg QSXGA2SXGA[] PROGMEM =
	{
		{0x3800, 0x00},
		{0x3801, 0x00},
		{0x3802, 0x00},
...
//2048x1536 QXGA
const struct sensor_reg QSXGA2QXGA[] PROGMEM =
	{
		{0x3800, 0x00},
		{0x3801, 0x00},
		{0x3802, 0x00},
...
//1600x1200 UXGA
const struct sensor_reg QSXGA2UXGA[] PROGMEM =
	{
		{0x3800, 0x00},
		{0x3801, 0x00},
		{0x3802, 0x00},
...
//1024x768 XGA
const struct sensor_reg QSXGA2XGA[] PROGMEM =
	{
		{0x3800, 0x00},
		{0x3801, 0x00},
		{0x3802, 0x00},
